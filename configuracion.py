...
def abrirArchivo(ruta):
    '''
    abre un archivo .json que contiene la configuracion
...
def nivel_facil(letrasPuntos,letrasCantidad):
    '''
    Modifica las opciones del juego (tipo de tablero, cantidad de fichas, palabras validas )

    Parametros:
    letrasPuntos -- diccionario que contiende todas las letras y los puntajes de cada puntaje
    letrasCantidad -- diccionario que contiene todas las letras y la cantidad de unidades de cada una

    Retorna:
    un diccionario con el puntaje de las letras, la cantidad de letras, el tipo de palabras valido, el tablero de juego y el nivel de dificultad
    '''
    letrasPuntosF={}
    letrasCantidadF={}
